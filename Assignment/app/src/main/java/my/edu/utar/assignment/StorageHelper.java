...
public class StorageHelper {
    ...
    private void preloadSampleData() {
        ...
        sampleList.add(new PasswordModel("Google", "Daniel", "danie123"));
        sampleList.add(new PasswordModel("Facebook", "Susan", "42fb11"));
        sampleList.add(new PasswordModel("Instagram", "John", "in93gr2m"));
        sampleList.add(new PasswordModel("Netflix", "Jack", "20netflix26"));
        sampleList.add(new PasswordModel("FoodPanda", "Emily", "fe7panda88"));
